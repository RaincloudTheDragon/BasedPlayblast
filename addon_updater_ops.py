...
# blender addon name
addon_package = "BasedPlayblast"  # Use same name here as in bl_info["name"]

# Must declare this before importing the addon updater module,
# it is used by the whole addon to refer to the addon updater.
updater = None

# Now import the updater module.
try:
    ...
    class Singleton_updater_none(object):
        ...
        def clear_state(self):
            ...
            self.error_msg = None
            self.async_checking = None
        def run_update(self, force=False, callback=None, clean=False):
            return
...
def register(bl_info):
    ...
    updater.repo = "BasedPlayblast"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/RaincloudTheDragon/BasedPlayblast"
    ...
    updater.include_branch_list = ['master']  # None is the equivalent = ['master']
